...
export class FindCoursesComponent implements OnInit {
  ...
  data = [

    {
      ...
      course_faculty: 'Accounting',
      course_cost: 'R2000',
      img: 'uj'
    },

    {
      university_name: 'Wits University',
      campus_name: 'Bunting',
      course_name: 'Auditing',
      course_faculty: 'Accounting',
      course_cost: 'R2000',
  ...
  showDetails(university_name ) {
    
    this.isDetails = true;
    if (university_name == 'uj') {
      this.university = 'uj';
    }  else if (university_name == 'wits'){
      this.university = 'wits';
    }  else if (university_name == 'up'){
      this.university = 'up';
    } else if (university_name == 'uct'){
      this.university = 'uct';
    }
